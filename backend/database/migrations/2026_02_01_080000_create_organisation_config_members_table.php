...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('organisation_config_members', function (Blueprint $table) {
            ...
            $table->boolean('has_family_membership')->default(false);
            ...
            $table->boolean('has_group_members')->default(false);
            $table->boolean('does_each_group_member_have_membership_number')->default(true);
